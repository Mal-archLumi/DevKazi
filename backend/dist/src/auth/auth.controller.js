...
let AuthController = class AuthController {
    ...
    async changePassword(req, changePasswordDto) {
        return this.authService.changePassword(req.user.userId, changePasswordDto.token, changePasswordDto.newPassword);
    }
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Invalid Google token' }),
